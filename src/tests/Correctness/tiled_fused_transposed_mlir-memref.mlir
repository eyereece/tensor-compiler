  ...
  func.func @main(%arg0: memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(unknown), %arg1: memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(unknown), %arg2: memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(unknown)) -> memref<2048x2048xf32> attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg3 = %c0 to %c2048 step %c1 {
      scf.for %arg4 = %c0 to %c2048 step %c1 {
        ...
        memref.store %0, %alloc_0[%arg3, %arg4] : memref<2048x2048xf32> loc(#loc1)
      } loc(#loc1)
    } loc(#loc1)
    scf.for %arg3 = %c0 to %c2048 step %c64 {
      scf.for %arg4 = %c0 to %c2048 step %c64 {
        %subview = memref.subview %arg0[%arg3, 0] [64, 2048] [1, 1] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> to memref<64x2048xf32, strided<[?, ?], offset: ?>> loc(#loc1)
        %subview_1 = memref.subview %alloc_0[%arg4, 0] [64, 2048] [1, 1] : memref<2048x2048xf32> to memref<64x2048xf32, strided<[2048, 1], offset: ?>> loc(#loc1)
        ...
        scf.for %arg5 = %c0 to %c2048 step %c64 {
          %subview_6 = memref.subview %subview[0, %arg5] [64, 64] [1, 1] : memref<64x2048xf32, strided<[?, ?], offset: ?>> to memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
          %subview_7 = memref.subview %subview_1[0, %arg5] [64, 64] [1, 1] : memref<64x2048xf32, strided<[2048, 1], offset: ?>> to memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc1)
          scf.for %arg6 = %c0 to %c64 step %c1 {
            scf.for %arg7 = %c0 to %c64 step %c1 {
              scf.for %arg8 = %c0 to %c64 step %c1 {
                ...
                %1 = memref.load %subview_7[%arg7, %arg8] : memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc1)
        ...
        %subview_4 = memref.subview %arg2[%arg3, %arg4] [64, 64] [1, 1] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> to memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc3)
        scf.for %arg5 = %c0 to %c64 step %c1 {
          scf.for %arg6 = %c0 to %c64 step %c1 {
        ...
        %subview_5 = memref.subview %alloc[%arg3, %arg4] [64, 64] [1, 1] : memref<2048x2048xf32> to memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc2)
        scf.for %arg5 = %c0 to %c64 step %c1 {
          scf.for %arg6 = %c0 to %c64 step %c1 {
            %0 = memref.load %alloc_2[%arg5, %arg6] : memref<64x64xf32> loc(#loc2)
            %1 = arith.maxnumf %0, %cst : f32 loc(#loc2)
            memref.store %1, %subview_5[%arg5, %arg6] : memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc2)
          } loc(#loc2)
        } loc(#loc2)
        memref.copy %subview_5, %subview_5 : memref<64x64xf32, strided<[2048, 1], offset: ?>> to memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc2)
      } loc(#loc2)
    } loc(#loc2)
    return %alloc : memref<2048x2048xf32> loc(#loc2)
  } loc(#loc)
} loc(#loc)
#loc1 = loc("matmul_out")
#loc2 = loc("Output")
