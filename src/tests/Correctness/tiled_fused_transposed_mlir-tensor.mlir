...
module {
  func.func @main(%arg0: tensor<2048x2048xf32> loc(unknown), %arg1: tensor<2048x2048xf32> loc(unknown), %arg2: tensor<2048x2048xf32> loc(unknown)) -> tensor<2048x2048xf32> attributes {llvm.emit_c_interface} {
    ...
    %1 = scf.for %arg3 = %c0 to %c2048 step %c64 iter_args(%arg4 = %0) -> (tensor<2048x2048xf32>) {
      %2 = scf.for %arg5 = %c0 to %c2048 step %c64 iter_args(%arg6 = %arg4) -> (tensor<2048x2048xf32>) {
        %extracted_slice = tensor.extract_slice %arg0[%arg3, 0] [64, 2048] [1, 1] : tensor<2048x2048xf32> to tensor<64x2048xf32> loc(#loc1)
        %extracted_slice_0 = tensor.extract_slice %transposed[%arg5, 0] [64, 2048] [1, 1] : tensor<2048x2048xf32> to tensor<64x2048xf32> loc(#loc1)
        %extracted_slice_1 = tensor.extract_slice %0[%arg3, %arg5] [64, 64] [1, 1] : tensor<2048x2048xf32> to tensor<64x64xf32> loc(#loc1)
        %3 = linalg.fill ins(%cst : f32) outs(%extracted_slice_1 : tensor<64x64xf32>) -> tensor<64x64xf32> loc(#loc1)
        %4 = scf.for %arg7 = %c0 to %c2048 step %c64 iter_args(%arg8 = %3) -> (tensor<64x64xf32>) {
          %extracted_slice_4 = tensor.extract_slice %extracted_slice[0, %arg7] [64, 64] [1, 1] : tensor<64x2048xf32> to tensor<64x64xf32> loc(#loc1)
          %extracted_slice_5 = tensor.extract_slice %extracted_slice_0[0, %arg7] [64, 64] [1, 1] : tensor<64x2048xf32> to tensor<64x64xf32> loc(#loc1)
        ...
        %extracted_slice_2 = tensor.extract_slice %arg2[%arg3, %arg5] [64, 64] [1, 1] : tensor<2048x2048xf32> to tensor<64x64xf32> loc(#loc3)
        ...
        %extracted_slice_3 = tensor.extract_slice %arg6[%arg3, %arg5] [64, 64] [1, 1] : tensor<2048x2048xf32> to tensor<64x64xf32> loc(#loc2)
        ...
        %inserted_slice = tensor.insert_slice %6 into %arg6[%arg3, %arg5] [64, 64] [1, 1] : tensor<64x64xf32> into tensor<2048x2048xf32> loc(#loc2)
        scf.yield %inserted_slice : tensor<2048x2048xf32> loc(#loc2)
      } loc(#loc2)
      scf.yield %2 : tensor<2048x2048xf32> loc(#loc2)
    } loc(#loc2)
    return %1 : tensor<2048x2048xf32> loc(#loc2)
  } loc(#loc)
} loc(#loc)
